...
SOURCE = ROOT / "assets" / "lumi-jelly-head-motion" / "imagegen-v1" / "keyed"
IMAGEGEN_ROOT = ROOT / "assets" / "lumi-jelly-head-motion" / "imagegen-v1"
DESTINATION = ROOT / "assets" / "lumi-jelly-head-motion"
STATE_NAMES = (
